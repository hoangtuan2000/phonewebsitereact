...
function TableOrderProduct({ product, changeNumberProduct, handleDeleteProductCart, numberProduct }) {
    let totalPrice = 0
    let promotionPrice = 0
    
    promotionPrice = reducedPrice(product[0].gia_sp, product[0].giam_km)
    totalPrice = totalPrice + promotionPrice * numberProduct
                            ...
                            <tr key={product.id_sp} className="text-center align-middle">
                                ...
                                <td style={{ width: '100px' }}>
                                    <InputGroup size='sm' >
                                        ...
                                        <FormControl id={`numberProductCart${product.id_sp}`} className="p-0 text-center" value={numberProduct} readOnly />
                                        <Button
                                            className="p-0"
                                            onClick={() => changeNumberProduct('plus')}
                                        >
                                ...
                                <td className="text-end">
                                    {
                                        moneyFormat(PromotionPrice * numberProduct) + ' đ'
                                    }
                                </td>
